 ...
 * Version:           1.0.0
 * Author:            Raza
 * Author URI:        razaalwani.ga
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       youtube-plugin
 ...
 */
define( 'YOUTUBE_PLUGIN_VERSION', '1.0.0' );
...
register_activation_hook( __FILE__, 'activate_youtube_plugin' );
register_deactivation_hook( __FILE__, 'deactivate_youtube_plugin' );

/**
 * The core plugin class that is used to define internationalization,
 * admin-specific hooks, and public-facing site hooks.
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-youtube-plugin.php';
 ...
 * @since    1.0.0
 */
function run_youtube_plugin() {

	$plugin = new Youtube_Plugin();
	$plugin->run();
